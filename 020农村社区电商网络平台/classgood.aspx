<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="classgood.aspx.cs" Inherits="classgood" %>
...
<div style="background-image: url('image/class.png'); background-repeat: no-repeat"  >
    ...
    <asp:Label ID="Label4" runat="server" Text="Laggbel" ForeColor="White" 
        Font-Size="20px" Font-Names="黑体" Font-Bold="True" CssClass="f"></asp:Label></div>
<asp:DataList ID="DataList1" runat="server" CellPadding="4" RepeatColumns="4" 
        Height="400px" Width="100%" HorizontalAlign="Center">
        <ItemTemplate>
