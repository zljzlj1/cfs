<%@ Page Language="C#" AutoEventWireup="true" CodeFile="splb.aspx.cs" Inherits="admin_splb" %>
...
<body style="background-color:transparent">
  ...
  <tr>
    ...
    <td valign="top"  style="background-image: url('images/content-bg.gif')"><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
      <tr>
        <td height="31"><div class="titlebt">商品类别</div></td>
      </tr>
    </table></td>
...
<div class="tab">
  <div id="bg" class="lanren1">
    <div id="font1" class="tab1" onmouseover="setTab03Syn(1);document.getElementById('bg').className='lanren1'">添加商品类别</div>
    <div id="font2" class="tab2" onmouseover="setTab03Syn(2);document.getElementById('bg').className='lanren2'">修改商品类别</div>
  </div>
  <div id="lanrenzhijia1">
     ...
     <div style=" margin-top:20px;">
           <font style="color: #000000; font-family: 楷体; font-weight: bold; font-size: 24px;" >商品类别：</font><asp:TextBox ID="TextBox1" runat="server" Class="s"></asp:TextBox>&nbsp&nbsp
  ...
  <div id="lanrenzhijia2" style="display:none"> 
    ...
    <asp:ImageButton ID="ImageButton2" runat="server" 
       ...
       <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
            AllowPaging="True" PageSize="5" Width="100%"  DataKeyNames="splbid" 
...
<asp:Label ID="Label2" runat="server" Text='<%# this.GridView2.PageIndex * this.GridView2.PageSize + this.GridView2.Rows.Count + 1%>' /> 
         ...
         <asp:BoundField DataField="lbmc" HeaderText="商品类别" />
