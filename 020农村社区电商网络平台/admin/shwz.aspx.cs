...
public partial class admin_shwz : System.Web.UI.Page
{
    ...
    protected void GridView5_content()
    {
        ...
        string strSj = "select txtid,titlername,txtrq,Username,txtfbzt,sftg,shzk from Txtinf,[User]  where Txtinf.UserID=[User].UserID and shzk='未审核' order by txtrq desc  ";
    ...
    protected void ss4()
    {
        ...
        if (t != "" && t != null)
        {
            ...
            string sql = "select txtid,titlername,txtrq,sftg,Username,txtfbzt,shzk from Txtinf,[User]   where Txtinf.UserID=[User].UserID and shzk='未审核'  and  titlername like '%" + t + "%'";
