...
public partial class admin_glyxx : System.Web.UI.Page
{
    ...
    {
        string strSj = "select * from Admin ";
    ...
    {
        string vadminid = GridView5.DataKeys[e.RowIndex].Value.ToString();
        string st = "delete from Admin where adminid='" + vadminid + "'";//删除记录
    ...
    protected void ss4()
    {
        ...
        if (t != "" && t != null)
        {
            ...
            if (ds.Tables[0].Rows.Count == 0)
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "test", "alert('无此管理员信息！');", true);
                GridView5_content();
    ...
    protected void GridView5_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                ((LinkButton)e.Row.Cells[6].Controls[0]).Attributes.Add("onclick", "javascript:return confirm('你确认要删除：\"" + e.Row.Cells[1].Text + "\"管理员吗?')");
            }
