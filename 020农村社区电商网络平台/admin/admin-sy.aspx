...
<body  leftmargin="0" topmargin="0">
    ...
    <div>
  <div><table width="100%" height="64" border="0" cellpadding="0" cellspacing="0" 
          class="admin_topbg" style="height: 64px">
  <tr>
    <td height="64" 
          style="width: 61%; background-image: url('images/logo.gif'); background-repeat: no-repeat;"></td>
