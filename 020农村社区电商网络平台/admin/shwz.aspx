<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shwz.aspx.cs" Inherits="admin_shwz" %>
 ...
 <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
  ...
  <tr>
    ...
    <td valign="top"  style="background-image: url('images/content-bg.gif')"><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
      <tr>
        <td height="31"><div class="titlebt">审核文章</div></td>
      </tr>
    </table></td>
  ...
  <tr>
   ...
   <font style="color: #000000; font-family: 楷体; font-weight: bold">文章：</font>
        <asp:TextBox ID="TextBox5" runat="server" Class="s"></asp:TextBox>
...
<asp:Label ID="Label2" runat="server" Text='<%# this.GridView5.PageIndex * this.GridView5.PageSize + this.GridView5.Rows.Count + 1%>' /> 
                ...
                <asp:HyperLinkField FooterText="查看" HeaderText="文章标题" Text="查看" 
                    ...
                    DataNavigateUrlFormatString="shwz-sh.aspx?id={0}" 
              ...
              <asp:HyperLinkField FooterText="查看" HeaderText="查看" Text="审核" 
                    DataNavigateUrlFields="txtid" 
                    DataNavigateUrlFormatString="shwz-sh.aspx?id={0}" >
                </asp:HyperLinkField>
