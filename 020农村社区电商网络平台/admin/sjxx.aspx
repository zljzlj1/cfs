<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sjxx.aspx.cs" Inherits="admin_sjxx" %>
 ...
 <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
  ...
  <tr>
    ...
    <td valign="top"  style="background-image: url('images/content-bg.gif')"><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
      <tr>
        <td height="31"><div class="titlebt">商家信息</div></td>
      </tr>
    </table></td>
    ...
    <div class="divtext">
        ...
        <tr >
            <td align="left" colspan="2" style="height:5px; background-color: #FFFF99;">
                ...
                注:不要把所有的商家全部删除，否则商家管理系统将无法登陆！</span></td>
        </tr>
     
</table>

   <font style="color: #000000; font-family: 楷体; font-weight: bold">商家：</font><asp:TextBox ID="TextBox5" runat="server" Class="s"></asp:TextBox>
    <asp:ImageButton ID="ImageButton5" runat="server" 
        ImageUrl="~/admin/images/1.jpg" onclick="ImageButton5_Click" />
       <asp:GridView ID="GridView5" runat="server" AutoGenerateColumns="False" 
            AllowPaging="True" PageSize="5" Width="100%"  DataKeyNames="sjid" 
...
<asp:Label ID="Label2" runat="server" Text='<%# this.GridView5.PageIndex * this.GridView5.PageSize + this.GridView5.Rows.Count + 1%>' /> 
                ...
                <asp:BoundField DataField="sjmc" HeaderText="商家" ReadOnly="True" />
      <asp:BoundField DataField="smm" HeaderText="密码" ReadOnly="True" />
                
             
                <asp:BoundField DataField="lxdh" HeaderText="联系电话" />
                <asp:BoundField DataField="lxrxm" HeaderText="联系人姓名" />
                <asp:BoundField DataField="jtdz" HeaderText="具体地址" />
                <asp:TemplateField HeaderText="入驻时间">
                     <ItemTemplate> <asp:Label ID="Label7" runat="server" Text='<%#Eval("rzsj", "{0:yyyy-MM-dd HH:mm:ss}" ) %>'></asp:Label>
                </ItemTemplate>
                </asp:TemplateField>
