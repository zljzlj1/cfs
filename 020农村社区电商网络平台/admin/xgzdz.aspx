<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xgzdz.aspx.cs" Inherits="admin_xgzdz" %>
 ...
 <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
  ...
  <tr style="height:29px;">
    ...
    <td valign="top"  style="background-image: url('images/content-bg.gif')"><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
      <tr>
        <td height="31"><div class="titlebt">镇名修改</div></td>
      </tr>
    </table></td>
  ...
  <tr>
    ...
    <div  class="divtext">
     <font style="color: #000000; font-family: 楷体; font-weight: bold">镇名：</font><asp:TextBox ID="TextBox4" runat="server" Class="s"></asp:TextBox>&nbsp&nbsp
    <asp:ImageButton ID="ImageButton4" runat="server" 
        ImageUrl="~/admin/images/1.jpg" onclick="ImageButton4_Click" />
       <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" 
            AllowPaging="True" PageSize="5" Width="100%"  DataKeyNames="zid" 
            onpageindexchanging="GridView4_PageIndexChanging" BackColor="#DEBA84" 
            BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" 
            CellSpacing="2" Height="250px" onrowdatabound="GridView4_RowDataBound" 
                  onrowdeleting="GridView4_RowDeleting" onrowediting="GridView4_RowEditing" 
                  onrowcancelingedit="GridView4_RowCancelingEdit" 
                  onrowupdating="GridView4_RowUpdating" GridLines="None" >
            <Columns>
                <asp:TemplateField HeaderText="序号"><ItemTemplate> 
<asp:Label ID="Label2" runat="server" Text='<%# this.GridView4.PageIndex * this.GridView4.PageSize + this.GridView4.Rows.Count + 1%>' /> 
</ItemTemplate> 
</asp:TemplateField>
        
                <asp:BoundField DataField="xm" HeaderText="县名" ReadOnly="True" />
      <asp:BoundField DataField="zm" HeaderText="镇名" />
        ...
        &nbsp;&nbsp;
        <asp:Label ID="Label7" runat="server" Text="Label" Font-Bold="True" Font-Names="楷体" ForeColor="Black"></asp:Label>
&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label8" runat="server" Text="Label" Font-Bold="True" Font-Names="楷体" ForeColor="Black"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp; 
       <asp:LinkButton ID="LinkButton13" runat="server" CommandArgument="f3" 
            onclick="link3" Font-Bold="True" Font-Names="楷体" ForeColor="Black">首页</asp:LinkButton>
        &nbsp;&nbsp;&nbsp;
        <asp:LinkButton ID="LinkButton14" runat="server" CommandArgument="p3" 
            onclick="link3" Font-Bold="True" Font-Names="楷体" ForeColor="Black">上一页</asp:LinkButton>
        &nbsp;&nbsp;&nbsp;
        <asp:LinkButton ID="LinkButton15" runat="server" CommandArgument="n3" 
            onclick="link3" Font-Bold="True" Font-Names="楷体" ForeColor="Black">下一页</asp:LinkButton>
        &nbsp;&nbsp;
        <asp:LinkButton ID="LinkButton16" runat="server" CommandArgument="l3" 
            onclick="link3" Font-Bold="True" Font-Names="楷体" ForeColor="Black">末页</asp:LinkButton>
