<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xgwz.aspx.cs" Inherits="xgwz" %>
            ...
            <tr>
                ...
                <td>
                    <textarea id="content1" cols="100" rows="60" 
                        style="width:619px; height:370px;visibility:hidden;" runat="server"> </textarea>
</td>
            </tr>
            <tr>
                <td class="style2">
