<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wdcz-ncpgx-ckxx.aspx.cs" Inherits="wdcz_ncpgx_ckxx" %>
  ...
  <div class="zhong"> <h5 style="margin-top: 2px; margin-left: 35px"><img src="image/ph.gif" /> 
    ...
    <table style="width:820px; height: 500px;">
        <tr>
            ...
            <tr><td class="style5" align="right">农产品类别:</td><td class="style7">
