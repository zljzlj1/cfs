...
public partial class spdjl : System.Web.UI.Page
{
    public static int Vsjid;
    public static string Vsjmc;
    ...
    public static Object getdata()
    {
        ...
        toSptjxx.text = Vsjmc + "商品点击量统计";
        toSptjxx.subtext = "为了增加销售量,需要把商品的点击量进行统计";
        toSptjxx.name = "数据来源";
        ...
        if (spModelList != null)
        {
            for (int i = 0; i < spModelList.Count; i++)
            {
                ...
                keyvalue.value = spModel.spdjl.ToString();
                data2.Add(keyvalue);
            }
