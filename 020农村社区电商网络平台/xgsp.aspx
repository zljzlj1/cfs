<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xgsp.aspx.cs" Inherits="xgsp" %>
    ...
    <table style="width:80%; height: 500px;">
        <tr>
            ...
            <tr><td class="style2"><span style="color: #FF0000; font-size: 9px;">*</span>单位</td><td class="style7">
                <asp:TextBox ID="TextBox3" runat="server" Width="71px" Height="19px"></asp:TextBox>
        ...
        <asp:Button ID="Button2" runat="server" onclick="Button2_Click" Text="更新" 
            style="width: 40px; height: 21px;" />&nbsp;
                <asp:Button ID="Button3" runat="server" Text="返回" PostBackUrl="~/xgspxx.aspx" />
                 </td>
            </tr>
        </table>
    </div>
