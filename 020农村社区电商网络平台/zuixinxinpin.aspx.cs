...
public partial class zuixinxinpin : System.Web.UI.Page
{
    ...
    {
        string SQLStr = "select  Sj.sjid,spid,sptp,spjg,spmc,spdjl,sjdjl from Sp,Sj where Sp.sjid=Sj.sjid and spzt='True'  order by spsjsj desc";
