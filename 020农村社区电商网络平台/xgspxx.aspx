<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xgspxx.aspx.cs" Inherits="xgspxx" %>
...
<asp:Label ID="Label2" runat="server" Text='<%# this.GridView2.PageIndex * this.GridView2.PageSize + this.GridView2.Rows.Count + 1%>' /> 
         ...
         <asp:BoundField DataField="spmc" HeaderText="商品名称" />
                      ...
                      <asp:BoundField DataField="spjg" HeaderText="商品价格"  />
             



                     <asp:TemplateField HeaderText="商品类别">
                <ItemTemplate><asp:Label ID="Label8" runat="server" Text='<% #Eval("lbmc")%>'></asp:Label></ItemTemplate>
                 <EditItemTemplate><asp:HiddenField ID="HiddenField4" runat="server" Value='<%#Eval("splbid") %>' /><asp:DropDownList ID="DropDownList2" runat="server"  Width="80px"></asp:DropDownList></EditItemTemplate> </asp:TemplateField>
                <asp:BoundField DataField="kcsl" HeaderText="商品库存数量" />




                     <asp:BoundField DataField="xssl" HeaderText="商品销售数量" ReadOnly="True" />
           ...
           <asp:HyperLinkField FooterText="修改" HeaderText="修改" Text="修改" 
                    DataNavigateUrlFields="spid" 
                    DataNavigateUrlFormatString="xgsp.aspx?id={0}" >
