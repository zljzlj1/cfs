...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table cellspacing="0" cellpadding="0" width="100%"  class="tablexian" border="0" style="height: 500px">
     ...
     <tr><td ><img src="image/1.gif" /></td></tr>
     ...
     <tr>
         <td align="right" style="width: 100px" >
                 <span style="color: #FF0000; font-size: 9px;">*</span>密码：</td>
         <td align="left">
                <asp:TextBox ID="TextBox2" runat="server" CssClass="s" TextMode="Password"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
        ControlToValidate="TextBox2" Display="Dynamic" ErrorMessage="请输入密码" 
        ForeColor="Red"></asp:RequiredFieldValidator>
         <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
                    ControlToValidate="TextBox2" Display="Dynamic" ErrorMessage="请输入正确的长度,长度为1-6个字符" 
                    ForeColor="Red" ValidationExpression="\S{1,6}"></asp:RegularExpressionValidator>`</td>
     </tr>
         <tr>
         <td align="right" style="width: 100px" >
                <span style="color: #FF0000; font-size: 9px;">*</span>密码确认：</td>
         <td align="left">
                <asp:TextBox ID="TextBox3" runat="server" CssClass="s" TextMode="Password"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
        ControlToValidate="TextBox3" Display="Dynamic" ErrorMessage="请输入密码" 
        ForeColor="Red"></asp:RequiredFieldValidator>
                <asp:CompareValidator ID="CompareValidator1" runat="server" 
                    ControlToCompare="TextBox2" ControlToValidate="TextBox3" 
                    ErrorMessage="密码不一致" ForeColor="Red"></asp:CompareValidator>
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                    ControlToValidate="TextBox3" Display="Dynamic" ErrorMessage="请输入正确的长度,长度为1-6个字符" 
        ...
        ForeColor="Red"></asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="code0" runat="server" 
                    ControlToValidate="TextBox4" Display="Dynamic" ErrorMessage="请输入正确的电话号码,长度为11" 
     ...
     <tr>
         <td align="right" style="width: 100px" >
                &nbsp;</td>
         <td align="left">
                <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/image/2.gif" 
