<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wdcz-zpxx.aspx.cs" Inherits="wdcz_zpxx" %>
...
<asp:DataList ID="DataList1" runat="server" CellPadding="4" RepeatColumns="1" 
          ...
          height="400px">
        <ItemTemplate>
          <div class="ssss">    <a href="wdcz-zpxx-ck.aspx?id=<%#Eval("xqid") %>" target="a"> <%#Container.ItemIndex+1 %>.<%#Eval("sjmc") %>:  <%#Eval("zpgw") %></a></div>
            </ItemTemplate>
...
Font-Size="9pt" onclick="Button1_Click"></asp:button>
   ...
   <div class="you"> <h5 style="margin-top: 8px; margin-left: 20px">最新文章排行</h5>
