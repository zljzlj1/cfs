...
<div style="height: 500px">
       ...
       不自提订单:<asp:Label ID="Label5" runat="server" Text="Label" Visible="False" Font-Bold="True" Font-Names="楷体" ForeColor="Black"></asp:Label>
...
<SortedDescendingHeaderStyle BackColor="#820000"></SortedDescendingHeaderStyle>
 ...
 自提订单:<asp:Label ID="Label2" runat="server" Text="Label" Visible="False" Font-Bold="True" Font-Names="楷体" ForeColor="Black"></asp:Label>
