<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="zuixinxinpin.aspx.cs" Inherits="zuixinxinpin" %>
...
<div style="background-image: url('image/bg11.png'); background-repeat: repeat-x"  ><img src="image/1.png" /></div>
       ...
       <div style="text-align: center">
          ...
          <a href="spxqxx.aspx?id=<%#Eval("spid") %>&&spdjl=<%#Eval("spdjl") %>&&sjdjl=<%#Eval("sjdjl")%>&&sjid=<%#Eval("sjid")%>"  > <asp:Image ID="Image1" runat="server" Height="120px" 
                           ...
                           <%#DataBinder.Eval(Container.DataItem,"spmc" )%>
                            <br />
                            <%#Eval("spjg").ToString().Trim() == "0.00" ? "面议" : Eval("spjg")%><span style="font-size: 10pt">￥</span> 
                            <br />
                         </a>   
