...
<table style="width:394px; height: 200px;border: thin dotted #000000;" runat =server id=table2 visible =false border="0" cellpadding="0" cellspacing="0" >
    ...
    <tr >
        <td style="width: 145px; height: 29px;">
            <asp:HyperLink ID="hpLinkMyCart" runat="server"  Font-Size="Small"  
                Font-Names="楷体" Font-Underline="False" 
                ForeColor="Black" NavigateUrl="~/gwc.aspx">我的购物车</asp:HyperLink><br />
            <asp:HyperLink ID="hpLinkOrder" runat="server" Font-Size="Small"  
                Font-Names="楷体" Font-Underline="False" 
                ForeColor="Black"
                NavigateUrl="~/ckdd.aspx" >查看订单</asp:HyperLink>
            ...
            <asp:HyperLink ID="hpLinkChangeInfo" runat="server" Font-Size="Small"  
                Font-Names="楷体" Font-Underline="False" 
                ForeColor="Black" NavigateUrl="~/gerenjbxx.aspx">个人基本信息</asp:HyperLink>
            <br />                 <asp:HyperLink ID="Hyperwdcc" runat="server" 
                ...
                Font-Size="Small"  Font-Names="楷体" Font-Underline="False" 
                ForeColor="Black" NavigateUrl="~/bdsp.aspx">本地商品</asp:HyperLink>
  <br />   
     <asp:HyperLink ID="HyperLink1" runat="server" 
                Font-Size="Small"  Font-Names="楷体" Font-Underline="False" 
                ForeColor="Black" NavigateUrl="~/bddpaspx.aspx">本地店铺</asp:HyperLink>
  <br />       
<asp:HyperLink ID="hpLinkChangePwd" runat="server" Font-Size="Small"  Font-Names="楷体" Font-Underline="False" 
                ForeColor="Black" NavigateUrl="~/usermm.aspx">修改密码</asp:HyperLink><br />
