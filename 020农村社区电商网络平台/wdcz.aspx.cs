...
public partial class wdcz : System.Web.UI.Page
{
    ...
    { //
        string sql = "select top(12) xqid,zpgw,sjmc,fbsj from Sjxqxx,Sj where Sjxqxx.sjid=Sj.sjid and qb='True' and scid='"+Session["cid"].ToString()+"' order by  fbsj desc  ";
    ...
    {//xqid,
        string sql = "select  top(12) xqid, fbsj ,sjmc,rcpxqmc,rcpxqsl,xqdw ,jg from Sjxqxx,Sj where Sjxqxx.sjid=Sj.sjid and qb='False' and scid='" + Session["cid"].ToString() + "'  order by  fbsj desc ";
        DataSet ds = DBA.GetDataSet(sql);
