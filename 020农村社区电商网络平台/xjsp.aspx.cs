...
public partial class xjsp : System.Web.UI.Page
{
    ...
    {
        string strSQ = "select spid,kcsl,spmc,spjg,spsjsj,spzt,lbmc  from Sp,Splb  where Splb.splbid=Sp.splbid and sjid='" + Session["sjid"].ToString() + "' and spzt='True' order by spsjsj desc ";
    ...
    protected void GridView2_RowEditing(object sender, GridViewEditEventArgs e)
    {
        ...
        GridView2.EditIndex = (int)e.NewEditIndex;
         ...
         if (t != "" && t != null)
         {
             string sql = "select spid,kcsl,spmc,spjg,spsjsj,spzt,lbmc  from Sp,Splb  where Splb.splbid=Sp.splbid and sjid='" + Session["sjid"].ToString() + "'and spzt='True' and spmc like '%" + t + "%' order by spsjsj desc  ";
    ...
    {//
     ...
     string sql = " update Sp set spzt='" + str + "',spxjsj='"+d+"' where spid='" + k + "' ";
        DataSet ds = DBA.GetDataSet(sql);
