<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xgncpxx.aspx.cs" Inherits="xgncpxx" %>
...
<asp:Label ID="Label2" runat="server" Text='<%# this.GridView5.PageIndex * this.GridView5.PageSize + this.GridView5.Rows.Count + 1%>' /> 
                ...
                <asp:BoundField DataField="rcpname" HeaderText="农产品名称" ReadOnly="True" />
      
                
                <asp:BoundField DataField="tgsl" HeaderText="提供数量" />
