<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="userddztxq.aspx.cs" Inherits="userddztxq" %>
...
<div style="height: 500px">
     ...
     <font style="color: #000000; font-family: 楷体; font-weight: bold"> 自提订单详情：</font><br />
      ...
      <br />  <font style="color: #000000; font-family: 楷体; font-weight: bold"> 购买时间：</font>     <asp:Label ID="Label3" runat="server" Text="Label"  Font-Bold="True" Font-Names="楷体" ForeColor="Black"></asp:Label>
            <br />  <font style="color: #000000; font-family: 楷体; font-weight: bold"> 订单总价格：<%=sum %></font>
        ...
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
            ...
            GridLines="None" PageSize="12" onrowdatabound="GridView2_RowDataBound" >
...
<asp:BoundField HeaderText="单价" DataField="spjg"></asp:BoundField>
                ...
                <ItemTemplate><asp:Label ID="Label11" runat="server" Text='<% #Eval("sjqr").ToString().Trim()=="False"?"未确认":"已确认"%>'></asp:Label>|<asp:Label ID="Label12" runat="server"  Text='<% #Eval("fh").ToString().Trim()=="False"?"未取货":"已取货"%>'></asp:Label><br /><asp:Label ID="Label13" runat="server" Text='<% #Eval("yhsfzf").ToString().Trim()=="False"?"未支付":"已支付"%>'></asp:Label></ItemTemplate>
              </asp:TemplateField>
            </Columns>
