<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xgxjsp.aspx.cs" Inherits="xgxjsp" %>
...
<body>
    ...
    <div>
                 ...
                 <font style="color: #000000; font-family: 楷体; font-weight: bold">下架商品：</font><asp:TextBox ID="TextBox2" runat="server" Class="s"></asp:TextBox>&nbsp&nbsp
...
<asp:Label ID="Label2" runat="server" Text='<%# this.GridView2.PageIndex * this.GridView2.PageSize + this.GridView2.Rows.Count + 1%>' /> 
         ...
         <asp:BoundField DataField="spmc" HeaderText="商品名称" ReadOnly="True" />
                ...
                <asp:BoundField DataField="kcsl" HeaderText="商品库存数量" ReadOnly="True" />
                     ...
                     <asp:TemplateField HeaderText="商品下架时间">
                <ItemTemplate><asp:Label ID="Label9" runat="server" Text='<% #Eval("spxjsj", "{0:yyyy-MM-dd HH:mm:ss}")%>'></asp:Label></ItemTemplate>
                </asp:TemplateField>
             ...
             <asp:CheckBoxField DataField="spzt" Text="上架" HeaderText="是否上架" />
