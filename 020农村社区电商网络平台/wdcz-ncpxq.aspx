<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wdcz-ncpxq.aspx.cs" Inherits="wdcz_ncpxq" %>
        ...
        <ItemTemplate>
                         <td>
                             <table class="zczz"
                                 ...
                                 <tr>
                                     <td align="center" class="style1" rowspan="3" width="10" style="height: 80px">
                                     ...
                                     <td >
                                      ...
                                      <a href="wdcz-ncpxq-ckxx.aspx?id=<%#Eval("xqid") %>">  农产品名称： <%#Eval("rcpxqmc")%>&nbsp;农产品种类：<%#Eval("ncpname")%></a></td>
                                 </tr>
                                 ...
                                 <tr>
                                     <td >
                                     <a href="wdcz-ncpxq-ckxx.aspx?id=<%#Eval("xqid") %>">  农产品数量：<%#Eval("rcpxqsl")%><%#Eval("xqdw")%>&nbsp;发布人：<%#Eval("sjmc")%></a></td>
             </tr>    
              <tr>
                                     <td >
                               <a href="wdcz-ncpxq-ckxx.aspx?id=<%#Eval("xqid") %>">农产品价格： <%#Eval("jg").ToString().Trim()=="0"?"面议":Eval("jg")%> (元/<%#Eval("xqdw") %>) </a> 发布日期:<%#Eval("fbsj", "{0:yyyy-MM-dd HH:mm:ss}")%></td>
             </tr>
                             </table>
                         </td>
                     </ItemTemplate>
 ...
 <asp:Label ID="Label4" runat="server" Text="Label" Visible="False" Font-Bold="True" Font-Names="楷体" ForeColor="Black"></asp:Label>
   ...
   <div class="you"> <h5 style="margin-top: 8px; margin-left: 20px">招聘信息<a 
      ...
      <ul class="ss">      <asp:Repeater ID="news" runat="server">
               <ItemTemplate><li><a href="wdcz-zpxx-ck.aspx?id=<%#Eval("xqid") %>"><%#Eval("sjmc") %>：<span ><%#Eval("zpgw") %><%#Eval("fbsj", "{0:yyyy-MM-dd HH:mm:ss}")%></span></a></li></ItemTemplate></asp:Repeater></ul>
